...
For example, a request to book an account on the WEB looks like this: lolz.guru/market/123/reserve?price=100, and an API request looks like this: **api**.lolz.guru/market/123/reserve?price=100
