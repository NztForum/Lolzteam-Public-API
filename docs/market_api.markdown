...
For example, a request to book an account on the WEB looks like this: `zelenka.guru/market/:itemId/reserve?price=:accountPrice`, and an API request looks like this: `api.zelenka.guru/market/:itemId/reserve?price=accountPrice`.
